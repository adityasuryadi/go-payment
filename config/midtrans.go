...
type MidtransPaymentImpl struct {
	Client        snap.Client
	CoreApiClient coreapi.Client
}

func NewMidtransPayment(configuration Config) MidtransPayment {
	mid := &MidtransPaymentImpl{}
...
func (m *MidtransPaymentImpl) CreateTokenTransactionWithGateway(request *snap.Request) (string, error) {
